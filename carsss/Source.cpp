...
public:
    ...
    void Show() override {
        ...
        cout << "Car" << endl;
        Vehicle::Show();
        cout << "Spoiler: " << (hasSpoiler ? "yes" : "no") << endl;
...
public:
    ...
    void Show() override {
        ...
        cout << "Ship" << endl;
        Vehicle::Show();
        cout << "Spoiler : " << (hasSail ? "yes" : "no") << endl;
...
int main()
{
    ...
    VehicleDepo* gaarage = new VehicleDepo();
    gaarage->AddVehicle(new Car("mercedes", "g", Engine(5, "g class", 5.1), 2));
    gaarage->ShowAllVehicle();
}